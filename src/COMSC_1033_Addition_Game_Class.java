...
public class COMSC_1033_Addition_Game_Class {
	public static void main(String[] args) {
		...
		int number1 = (int)(Math.random() * generateRandomNumberByHardness(hardness));
		int number2 = (int)(Math.random() * generateRandomNumberByHardness(hardness));
...
public static int generateRandomNumberByHardness (int hardness){
	return (int)(Math.random()*hardness);
}//End generateRandomNumberByHardness method
